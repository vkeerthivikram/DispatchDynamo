...
//// forget password
  ...
  otpvalue:any;
  getOTP(){
    this.http.post(this.baseUrl+"/api/v1/auth/getOtp",this.customerSignUp.value.emailId)
  ...
  passwordOTP(){
    if(this.forgotPassword.value.emailId!=null) {
      this.http.post(this.baseUrl+"/api/v1/auth/getOtp", this.forgotPassword.value.emailId)
          .subscribe(data => this.otpvalue = data)
...
emailId:any;
  ...
  changePassword(){
    ...
    this.http.post(this.baseUrl+"/api/v1/auth/updatepassword",this.forgotpass)
